...
\begin{frontmatter}
    ...
    \title{Positivity-preserving algorithm for implicit finite
    ...
    \author[BSSC]{Qian Wang}
    \author[THUDEM]{Hanyu Zhou}

    \affiliation[BSSC]
    {
        organization=
            { Beijing Computational Science Research Center},%Department and Organization
        city={Beijing},
        postcode={100088},
        country={China}
    }
